...
class Words_DB:
    class blacklists:
        ...
        suspicious_list = [
            ...
            "куплю", "курьер", "кэшбек", "кэшбэк", "менеджер", "оплата", "опрос", "партнер", "пиши", "подписывайтесь", "подпишись", "подпишитесь",
            "подработ", "подробности", "покупк", "приз", "продам", "регистратор", "розыгрыш", "рубл", "самокат", "скупаю", "скидка", "слабонерв", "телеграм",
            "телефон", "халяв", "ценам", "заработ", "мелстрой", "сертификат", "хомячки", "топовый", "маркет", "промоакц", "лохотрон", "купон", "канцтовар",
            "инста", "инсте", "инсту", "ивент", "эльдорад", "промик", "comedy", "тнт", "деньг", "бонус", "wb", "wildberr", "вайлбер", "вайлдбер", "валбер", "валдбер",
            "валбир", "comedy", "промокод", "конкурс"
        ]
    whitelist = [
