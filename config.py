...
class Words_DB:
    class blacklists():
        abc = {
            'а': '[a4а@αᴀ]', 'б': '[6бҕb６]', 'в': '[вvɓbw]', 'г': '[гg]', 'д': '[d∂д]', 'е': '[e℮ᴇ3еiи]', 'ж': '(?:ж|zh)', 'з': '[3зz]',
            'и': '[iи1йыu]', 'й': '[iи1йыu]', 'к': '[кҡkxх]', 'л': '[l1л]', 'м': '[mмʍ]', 'н': '[nhн]', 'о': '[o0оọσõｏ]', 'п': '[пnpρ]', 'р': '[pᴩrрρ]', 'с': '[сcċцs]', 'т': '[тtτ]', 'у': '[yуẏuʏ]', 'ф': '[фf]', 'х': '[xх]', 'ц': '[cц]', 'ч': '[hч4]',
            'ш': '[ш]', 'щ': '[щ]', 'ь': '[bьъ]', 'ы': '[iи1йыu]', 'ъ': '[bъь]', 'э': '[e3еiи]', 'ю': '[ю]', 'я': '[я]'
        }
        regex_list = [
            ...
            f"(?:{abc['п']}{abc['и']}{abc['з']}]{abc['д']}|{abc['п']}{abc['и']}{abc['с']}{abc['д']}|{abc['п']}{abc['е']}{abc['з']}{abc['д']}|{abc['п']}{abc['е']}{abc['с']}{abc['д']})",
        ...
        suspisious_regex = [
            ...
            f"{abc['з']}{abc['а']}{abc['р']}{abc['а']}{abc['б']}{abc['о']}{abc['т']}",
            f"{abc['в']}h?(?:{abc['а']}|{abc['о']})(?:[cц]|ts|тс){abc['а']}{abc['п']}+",
            f"{abc['а']}{abc['в']}{abc['и']}{abc['т']}{abc['о']}",
            f"{abc['т']}{abc['е']}{abc['л']}{abc['е']}{abc['г']}",
        ]
        suspicious_list = [
            "аккаунт", "акци", "аренд", "бесплатн", "ваканс",
            "выплат", "гривен", "гривна", "доставка", "доход", "евро", "заказ",
            ...
            "покупк", "продам", "регистратор", "розыгрыш", "рубл", "самокат", "скупаю", "скидк", "слабонерв",
            "телеграм", "телефон", "халяв", "ценам", "мелстрой", "сертификат", "хомячки", "топовый", "маркет",
            "промоакц", "лохотрон", "купон", "канцтовар", "ивент", "эльдорад", "промик",
    ...
    class whitelists:
        exclusions = [
            ...
            "розробл", "чмок", "вопрос", "призм", "полторашк", "иб", "сип", "себ", "себя", "нибудь", "ибо", "корабл",
            "ибк", "вибр", "реакц", "реакт", "призв", "призн", "мудр"]
