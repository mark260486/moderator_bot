...
class Words_DB:
    class blacklists:
        ...
        suspicious_list = [
            ...
            "comedy", "промокод", "конкурс"]

    class whitelists:
        exclusions = [
            "блямб", "блях", "бляш", "влюб", "греб", "дуб", "заглуб", "истреб", "канальн", "колеб", "обляп", "оглоб",
            "озлоб", "оскорб", "пособ", "потреб", "радиоактив", "раздроб", "расслаб", "углуб", "укрыт", "виробл",
