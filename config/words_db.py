...
class Words_DB:
    class blacklists():
        ...
        abc: dict[str, str] = {
            'а': '[𝚊a4а@αᴀ🅐ᗩ₳𝙰]', 'б': '[б6бҕb６]', 'в': '[вvɓbw]', 'г': '[гgr]', 'д': '[d∂д]', 'е': '[𝚎e℮ᴇ3еiи]', 'ж': '[жҗ]',
            'з': '[3зz]', 'и': '[iи1йыu]', 'й': '[iи1йыu]', 'к': '[кҡkxх]', 'л': '[l1л]', 'м': '[mмʍ]', 'н': '[nhннн]',
            'о': '[𝚘𝚘o0оọσõｏ🅞Øᴏ𝐎]', 'п': '[пnpρ]', 'р': '[𝚙pᴩrрρ]', 'с': '[сcċцs]', 'т': '[ттттt𝗧τm]', 'у': '[уyуẏuʏ]', 'ф': '[фf]',
    ...
    class whitelists:
        ...
        exclusions: list[str] = [
            ...
            "различ", "единолич", "вкрапл", "лепл", "цепл", "лупл", "тупл", "топл", "копл", "слепл", "крепл",
        ]
