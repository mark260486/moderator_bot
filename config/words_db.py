...
class Words_DB:
    class blacklists():
        ...
        abc: dict[str, str] = {
            'а': '[𝚊a4а@αᴀ🅐ᗩ₳𝙰𝐀𝙖]', 'б': '[б6бҕb６]', 'в': '[𝗕вvɓbw]', 'г': '[гgr]', 'д': '[d∂д]', 'е': '[𝚎e℮ᴇ3еiи]', 'ж': '[жҗ]',
            'з': '[3зz]', 'и': '[iи1йыu]', 'й': '[iи1йыu]', 'к': '[кҡkxх]', 'л': '[l1л]', 'м': '[mмʍ]', 'н': '[nhннн]',
            'о': '[𝚘o0оọσõｏ🅞Øᴏ𝐎]', 'п': '[пnpρ]', 'р': '[𝚙pᴩrрρ𝙥]', 'с': '[сcċцs]', 'т': '[тt𝗧τm]', 'у': '[уyуẏuʏ]', 'ф': '[фf]',
        ...
        suspicious_regex: list[str] = [
            ...
            f"{abc['р']}{abc['а']}{abc['б']}{abc['о']}{abc['т']}",  # заработ/подработ
